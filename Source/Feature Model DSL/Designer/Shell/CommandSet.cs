...
namespace ISpySoft.FeatureModelLanguage.Designer
	...
	internal class CommandSet : Microsoft.VisualStudio.Modeling.Utilities.CommandSet
	{
		...
		{
			FeatureModelLanguageModelExplorer explorer = this.ModelExplorer;
			if ( explorer != null )
			{
				explorer.Show();
			}
		...
		/// </summary>
		internal FeatureModelLanguageDocData CurrentData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as FeatureModelLanguageDocData;
			}
		}
		...
		internal FeatureModelLanguageDocView CurrentView
		{
			get
			{
				return base.CurrentDocView as FeatureModelLanguageDocView;
			}
		}
		...
		/// Browser tool window.
		/// </summary>
		internal FeatureModelLanguageModelExplorer ModelExplorer
		{
			get
			{
				return base.ModelExplorerToolWindow as FeatureModelLanguageModelExplorer;
			}
		}
		...
		protected override Type ModelExplorerType
		{
			get
			{
				return typeof(FeatureModelLanguageModelExplorer);
			}
		}
	}
}
