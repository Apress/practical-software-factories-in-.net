...
namespace ISpySoft.FeatureModelLanguage.Designer
{
	...
	public class EditorFactory : ModelingEditorFactory
	{
		...
		protected const int RelationshipFeatureConnectorPosition = 3;
	
		protected const int RelationshipFeatureSetConnectorPosition = 4;
		public const string RelationshipFeatureConnectorFilterString = "RelationshipFeatureConnectorFilterString";
		public const string RelationshipFeatureSetConnectorFilterString = "RelationshipFeatureSetConnectorFilterString";
		#endregion

		public EditorFactory(FeatureModelLanguagePackage package) : base(package)
		{
		}
		...
		protected override DocData CreateDocData(string fileName, IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new FeatureModelLanguageDocData(this.ServiceProvider, this);
		}

		protected override DocView CreateDocView(DocData docData, string physicalView, out string editorCaption)
		{
			editorCaption = "";
			return new FeatureModelLanguageDocView(docData, this.ServiceProvider);
		}
