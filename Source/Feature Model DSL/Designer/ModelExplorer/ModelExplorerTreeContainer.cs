...
namespace ISpySoft.FeatureModelLanguage.Designer{
	...
	public sealed class TreeContainer : ModelExplorerTreeContainer
	{
		...
		protected override System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return new System.ComponentModel.Design.CommandID(GuidList.guidFeatureModelLanguageMenu, PackageMenuIdList.menuIdExplorer);
			}
		}
		...
		{
			MetaClassInfo rootMetaClass = store.MetaDataDirectory.FindMetaClass(typeof(ISpySoft.FeatureModelLanguage.DomainModel.FeatureModel));
